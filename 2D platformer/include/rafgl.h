...
void rafgl_raster_draw_spritesheet_lighter(rafgl_raster_t *raster, rafgl_spritesheet_t *spritesheet, int sheet_x, int sheet_y, int x, int y)
{
    int fl, fr, fu, fd;
    int flc, frc, fuc, fdc;
    int xi, yi;
    ...
    for(yi = fuc; yi < fdc; yi++)
    {
        for(xi = flc; xi < frc; xi++)
        {
            ...
            if(sampled.rgba != RAFGL_COLOUR_KEY.rgba)
            {
                pixel_at_pm(raster, xi, yi).rgba =  rafgl_RGB(rafgl_saturatei(sampled.r+80), rafgl_saturatei(sampled.g+80), rafgl_saturatei(sampled.b+80));
            }
        }
    }
...
void rafgl_raster_draw_spritesheet_green(rafgl_raster_t *raster, rafgl_spritesheet_t *spritesheet, int sheet_x, int sheet_y, int x, int y)
{
    int fl, fr, fu, fd;
    int flc, frc, fuc, fdc;
    int xi, yi;
    ...
    for(yi = fuc; yi < fdc; yi++)
    {
        for(xi = flc; xi < frc; xi++)
        {
            ...
            if(sampled.rgba != RAFGL_COLOUR_KEY.rgba)
            {
                ...
                pixel_at_pm(raster, xi, yi).rgba = rafgl_RGB(rafgl_saturatei(sampled.r-210), rafgl_saturatei(sampled.g-210/3), rafgl_saturatei(sampled.b-210));
            }
        }
    }
...
void rafgl_raster_draw_spritesheet_random_color(rafgl_raster_t *raster, rafgl_spritesheet_t *spritesheet, int sheet_x, int sheet_y, int x, int y)
{
    int fl, fr, fu, fd;
    int flc, frc, fuc, fdc;
    int xi, yi;
    ...
    for(yi = fuc; yi < fdc; yi++)
    {
        for(xi = flc; xi < frc; xi++)
        {
            ...
            if(sampled.rgba != RAFGL_COLOUR_KEY.rgba)
            {
                if(sampled.rgba == rafgl_RGB(16, 123, 41) || sampled.rgba == rafgl_RGB(65, 164, 41) || sampled.rgba == rafgl_RGB(13, 66, 13)){
                    sampled.r = rafgl_saturatei(rand()%256);
                    sampled.g = rafgl_saturatei(rand()%256);
                    sampled.b = rafgl_saturatei(rand()%256);
                }
                pixel_at_pm(raster, xi, yi) = sampled;
            }
        }
...
int rafgl_raster_draw_raster_random_color(rafgl_raster_t *to, rafgl_raster_t *from, int x, int y)
{
...
int rafgl_raster_draw_raster_lighter(rafgl_raster_t *to, rafgl_raster_t *from, int x, int y)
{
    ...
    for(yi = fuc; yi < fdc; yi++)
    {
        for(xi = flc; xi < frc; xi++)
        {
            ...
            if(sampled.rgba != RAFGL_COLOUR_KEY.rgba)
            {
                pixel_at_pm(to, xi, yi).rgba = rafgl_RGB(rafgl_saturatei(sampled.r+50), rafgl_saturatei(sampled.g+50), rafgl_saturatei(sampled.b+50));
            }
        }
    }
...
int rafgl_raster_draw_raster_mushroom(rafgl_raster_t *to, rafgl_raster_t *from, int x, int y)
{
    ...
    int rand1_br = rafgl_saturatei(rand()%256);
    int rand2_br = rafgl_saturatei(rand()%256);
    int rand3_br = rafgl_saturatei(rand()%256);
    ...
    for(yi = fuc; yi < fdc; yi++)
    {
        for(xi = flc; xi < frc; xi++)
        {
            ...
            if(sampled.rgba != RAFGL_COLOUR_KEY.rgba)
            {
                if(sampled.rgba == rafgl_RGB(255, 26, 26) || sampled.rgba == rafgl_RGB(211, 26, 26)){
                    sampled.r = rand1_br;
                    sampled.g = rand2_br;
                    sampled.b = rand3_br;
                }
